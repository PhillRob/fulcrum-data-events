//WS Construction Inspection Form v0.1
// global
...
// put roles here when global roles do not work
  ...
  if (ISROLE(supervisor))
  {
    ...
    // filter status field
    SETSTATUSFILTER(['Documentation - توثيق','Work Request - طلب عمل','Query - استعلام','Work in progress - تقدم العمل','Request for Inspection - طلب للفحص','Instruction draft - مسودة التعليمات ']);
  }
...
ON('edit-record', function(event) {
  ...
  if (ISROLE(supervisor))
  {
    ...
    // filter status field
    SETSTATUSFILTER(['Documentation - توثيق','Work Request - طلب عمل','Query - استعلام','Work in progress - تقدم العمل','Request for Inspection - طلب للفحص','Instruction draft - مسودة التعليمات ','Approved - موافق عليه','Approved with comments - وافق مع التعليقات','Rejected - مرفوض','Revise and resubmit - مراجعة و إعادة تقديم','Revision in progress - قيد المراجعة']);
  }
  ...
  if (ISROLE(management))
  {
    ...
    // filter status field
    SETSTATUSFILTER(['Documentation - توثيق','Site instruction - تعليمات الموقع','Instruction draft - مسودة التعليمات ','Query - استعلام','Request for Inspection - طلب للفحص','Work Request - طلب عمل','Approved - موافق عليه','Approved with comments - وافق مع التعليقات','Rejected - مرفوض','Revise and resubmit - مراجعة و إعادة تقديم','Final approval - الموافقة النهائية']);
  }
});
