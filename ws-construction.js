...
//geo-fencing when chaning record
...
if (ISROLE(supervisorRoles))
  //(supervisorRoles.indexOf(ROLE()) !== -1) 
{
...
// if current role is management client
if (ISROLE(managementRoles))
  //(managementRoles.indexOf(ROLE()) !== -1) 
{
